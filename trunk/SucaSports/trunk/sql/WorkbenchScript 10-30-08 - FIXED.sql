...
CREATE  TABLE IF NOT EXISTS `suca_sports`.`alquiler` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `ix_alquileres_equipamiento_id` (`id_equipamiento` ASC) ,
  INDEX `ix_alquileres_usuarios` (`id_usuario` ASC) ,
  INDEX `ix_alquileres_fechaetapacarrera` (`id_carrera` ASC, `fecha_inicio_etapa` ASC, `id_etapa_carrera` ASC) ,
  ...
  CONSTRAINT `fk_alquileres_fechaetapacarrera`
    FOREIGN KEY `fk_alquileres_fechaetapacarrera` (`fecha_inicio_etapa`, `id_etapa_carrera`, `id_carrera`)
    REFERENCES `fecha_etapa_carrera` (`fecha_inicio`, `id_etapa_carrera`, `id_carrera`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE  TABLE IF NOT EXISTS `suca_sports`.`cuenta_corriente` (
  ...
  INDEX `ix_cuenta_corriente_fecha_de_pago_desc` (`fecha_de_pago` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `suca_sports`.`equipamiento_carrera` (
  ...
  `updated_at` TIMESTAMP NULL DEFAULT NULL ,
  `updated_by` INT(11) NULL DEFAULT NULL ,
  `id_etapa_carrera` INT(11) NULL DEFAULT NULL ,
  `fecha_inicio_etapa` DATE NULL DEFAULT NULL ,
  ...
  CONSTRAINT `fk_equipamiento_carrera_id_carrera` FOREIGN KEY `fk_equipamiento_carrera_id_carrera` (`fecha_inicio_etapa`, `id_etapa_carrera`, `id_carrera`)
    REFERENCES `fecha_etapa_carrera` (`fecha_inicio`, `id_etapa_carrera`, `id_carrera`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_equipamiento_carrera_tipo_equipamiento` FOREIGN KEY `fk_equipamiento_carrera_tipo_equipamiento` (`id_tipo_equipamiento`)
...
CREATE  TABLE IF NOT EXISTS `suca_sports`.`resultado` (
  ...
  INDEX `ix_resultado_corredor` (`id_corredor` ASC) ,
  INDEX `ix_resultado_fechaetapacarrera` (`id_carrera` ASC, `id_etapa_carrera` ASC, `fecha_inicio_etapa` ASC) ,
  CONSTRAINT `fk_resultado_corredor` FOREIGN KEY `fk_resultado_corredor` (`id_corredor`)
    REFERENCES `corredor` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_resultado_fechaetapacarrera` FOREIGN KEY `fk_resultado_fechaetapacarrera` (`fecha_inicio_etapa`, `id_etapa_carrera`, `id_carrera`)
    REFERENCES `fecha_etapa_carrera` (`fecha_inicio`, `id_etapa_carrera`, `id_carrera`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB

...
/**
 * This class adds structure of 'permiso' table to 'propel' DatabaseMap object.
 *
 *
...
class PermisoMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addPrimaryKey('PERMISO', 'Permiso', 'VARCHAR', true, 15);

		$tMap->addForeignPrimaryKey('GRUPOS_ID', 'GruposId', 'INTEGER' , 'grupo', 'ID', true, 11);

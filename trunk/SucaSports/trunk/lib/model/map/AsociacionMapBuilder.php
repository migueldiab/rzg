...
class AsociacionMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.AsociacionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('asociacion');
		$tMap->setPhpName('Asociacion');
		...
		$tMap->addColumn('CONTACTO', 'Contacto', 'string', CreoleTypes::VARCHAR, false, 45);

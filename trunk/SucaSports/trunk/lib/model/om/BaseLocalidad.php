...
abstract class BaseLocalidad extends BaseObject  implements Persistent {
  ...
  const PEER = 'LocalidadPeer';
	...
	/**
	 * Initializes internal state of BaseLocalidad object.
	 * @see        applyDefaults()
	 */
	 ...
	 * related Corredors from storage. If this Localidad is new, it will return
		...
		if ($this->collCorredors === null) {
			if ($this->isNew()) {
			   $this->collCorredors = array();
				...
				$criteria->add(CorredorPeer::ID_LOCALIDAD, $this->id);

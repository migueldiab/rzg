...
abstract class BasePermisoPeer {
	...
	/** the column name for the GRUPOS_ID field */
	...
	/**
	 * An identiy map to hold any loaded instances of Permiso objects.
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('permiso', 'gruposId', 'updatedAt', 'updatedBy', ),
		BasePeer::TYPE_COLNAME => array (self::PERMISO, self::GRUPOS_ID, self::UPDATED_AT, self::UPDATED_BY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('permiso' => 0, 'gruposId' => 1, 'updatedAt' => 2, 'updatedBy' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::PERMISO => 0, self::GRUPOS_ID => 1, self::UPDATED_AT => 2, self::UPDATED_BY => 3, ),
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BasePermisoPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BasePermisoPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Permiso $value A Permiso object.
	...
	public static function addInstanceToPool(Permiso $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getPermiso(), (string) $obj->getGruposId()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Permiso) {
				$key = serialize(array((string) $value->getPermiso(), (string) $value->getGruposId()));
	...
	public static function doCountJoinGrupo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(PermisoPeer::GRUPOS_ID,), array(GrupoPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Permiso objects pre-filled with their Grupo objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasePermisoPeer', $c, $con);
    }
		...
		$startcol = (PermisoPeer::NUM_COLUMNS - PermisoPeer::NUM_LAZY_LOAD_COLUMNS);
		GrupoPeer::addSelectColumns($c);

		$c->addJoin(array(PermisoPeer::GRUPOS_ID,), array(GrupoPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Permiso) to $obj2 (Grupo)
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasePermisoPeer', $c, $con);
    }
		...
		PermisoPeer::addSelectColumns($c);
		$startcol2 = (PermisoPeer::NUM_COLUMNS - PermisoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Permiso) to the collection in $obj2 (Grupo)
				$obj2->addPermiso($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BasePermisoPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BasePermisoPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BasePermisoPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BasePermisoPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BasePermisoPeer', $values, $con, $ret);
    }
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(PermisoPeer::PERMISO, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(PermisoPeer::GRUPOS_ID, $value[1]));
				$criteria->addOr($criterion);

				// we can invalidate the cache for this single PK
				PermisoPeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 * @return     Permiso
	 */
	public static function retrieveByPK($permiso, $grupos_id, PropelPDO $con = null) {
		$key = serialize(array((string) $permiso, (string) $grupos_id));
 		if (null !== ($obj = PermisoPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the PermisoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PermisoPeer class:
//
// Propel::getDatabaseMap(PermisoPeer::DATABASE_NAME)->addTableBuilder(PermisoPeer::TABLE_NAME, PermisoPeer::getMapBuilder());
//

...
abstract class BaseTipoDocumentoPeer {
    ...
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseTipoDocumentoPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseTipoDocumentoPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseTipoDocumentoPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseTipoDocumentoPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseTipoDocumentoPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseTipoDocumentoPeer', $values, $con, $ret);
    }
...
//
// NOTE: This static code cannot call methods on the TipoDocumentoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the TipoDocumentoPeer class:
//
// Propel::getDatabaseMap(TipoDocumentoPeer::DATABASE_NAME)->addTableBuilder(TipoDocumentoPeer::TABLE_NAME, TipoDocumentoPeer::getMapBuilder());
//

...
abstract class BaseTipoDocumentoPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (TipoDocumentoPeer::ID, TipoDocumentoPeer::NOMBRE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (TipoDocumentoPeer::ID => 0, TipoDocumentoPeer::NOMBRE => 1, ),
	...
	const COUNT = 'COUNT(tipo_documento.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tipo_documento.ID)';

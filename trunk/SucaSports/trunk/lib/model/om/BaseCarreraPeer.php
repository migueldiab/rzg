...
abstract class BaseCarreraPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'url', 'descripcion', 'createdAt', 'createdBy', 'updatedAt', 'updatedBy', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE, self::URL, self::DESCRIPCION, self::CREATED_AT, self::CREATED_BY, self::UPDATED_AT, self::UPDATED_BY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'url' => 2, 'descripcion' => 3, 'createdAt' => 4, 'createdBy' => 5, 'updatedAt' => 6, 'updatedBy' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE => 1, self::URL => 2, self::DESCRIPCION => 3, self::CREATED_AT => 4, self::CREATED_BY => 5, self::UPDATED_AT => 6, self::UPDATED_BY => 7, ),
    ...
    foreach (sfMixer::getCallables('BaseCarreraPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseCarreraPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseCarreraPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseCarreraPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseCarreraPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseCarreraPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseCarreraPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseCarreraPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseCarreraPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseCarreraPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseCarreraPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseCarreraPeer', $values, $con, $ret);
    }
...
//
// NOTE: This static code cannot call methods on the CarreraPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CarreraPeer class:
//
// Propel::getDatabaseMap(CarreraPeer::DATABASE_NAME)->addTableBuilder(CarreraPeer::TABLE_NAME, CarreraPeer::getMapBuilder());
//

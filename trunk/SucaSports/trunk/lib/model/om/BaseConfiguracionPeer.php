...
abstract class BaseConfiguracionPeer {
	...
	/** the column name for the PARAMETRO field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parametro', 'valor', 'descripcion', 'updatedAt', 'updatedBy', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARAMETRO, self::VALOR, self::DESCRIPCION, self::UPDATED_AT, self::UPDATED_BY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parametro' => 1, 'valor' => 2, 'descripcion' => 3, 'updatedAt' => 4, 'updatedBy' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARAMETRO => 1, self::VALOR => 2, self::DESCRIPCION => 3, self::UPDATED_AT => 4, self::UPDATED_BY => 5, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ConfiguracionMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseConfiguracionPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseConfiguracionPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseConfiguracionPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseConfiguracionPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseConfiguracionPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseConfiguracionPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseConfiguracionPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Configuracion) {
...
//
// NOTE: This static code cannot call methods on the ConfiguracionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ConfiguracionPeer class:
//
// Propel::getDatabaseMap(ConfiguracionPeer::DATABASE_NAME)->addTableBuilder(ConfiguracionPeer::TABLE_NAME, ConfiguracionPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseConfiguracionPeer::DATABASE_NAME)->addTableBuilder(BaseConfiguracionPeer::TABLE_NAME, BaseConfiguracionPeer::getMapBuilder());

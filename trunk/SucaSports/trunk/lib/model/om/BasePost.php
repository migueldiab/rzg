...
abstract class BasePost extends BaseObject  implements Persistent {
  ...
  const PEER = 'PostPeer';
	...
	/**
	 * The value for the fecha_etapa_carrera_fecha_inicio field.
	 * @var        string
	 */
	protected $fecha_etapa_carrera_fecha_inicio;

	/**
	 * The value for the fecha_etapa_carrera_id_etapa field.
	 * @var        int
	 */
	protected $fecha_etapa_carrera_id_etapa;

	/**
	 * The value for the fecha_etapa_carrera_id_carrera field.
	 * @var        int
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [fecha_etapa_carrera_fecha_inicio] column value.
	 * 
	 *
	 * @param      string $format The date/time format string (either date()-style or strftime()-style).
	 *							If format is NULL, then the raw DateTime object will be returned.
	...
	{
		if ($this->fecha_etapa_carrera_fecha_inicio === null) {
			return null;
		}


		if ($this->fecha_etapa_carrera_fecha_inicio === '0000-00-00') {
			// while technically this is not a default value of NULL,
			// this seems to be closest in meaning.
			return null;
		} else {
			try {
				$dt = new DateTime($this->fecha_etapa_carrera_fecha_inicio);
			} catch (Exception $x) {
				throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->fecha_etapa_carrera_fecha_inicio, true), $x);
			}
		}
	...
	/**
	 * Get the [fecha_etapa_carrera_id_etapa] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [fecha_etapa_carrera_id_carrera] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Sets the value of [fecha_etapa_carrera_fecha_inicio] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     Post The current object (for fluent API support)
	...
	public function setFechaEtapaCarreraFechaInicio($v)
	{
		...
		if ( $this->fecha_etapa_carrera_fecha_inicio !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->fecha_etapa_carrera_fecha_inicio !== null && $tmpDt = new DateTime($this->fecha_etapa_carrera_fecha_inicio)) ? $tmpDt->format('Y-m-d') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->fecha_etapa_carrera_fecha_inicio = ($dt ? $dt->format('Y-m-d') : null);
				$this->modifiedColumns[] = PostPeer::FECHA_ETAPA_CARRERA_FECHA_INICIO;
			}
		} // if either are not null

		return $this;
	} // setFechaEtapaCarreraFechaInicio()

	/**
	 * Set the value of [fecha_etapa_carrera_id_etapa] column.
	 * 
	 * @param      int $v new value
	 * @return     Post The current object (for fluent API support)
	 */
	public function setFechaEtapaCarreraIdEtapa($v)
	{
		...
		return $this;
	} // setFechaEtapaCarreraIdEtapa()

	/**
	 * Set the value of [fecha_etapa_carrera_id_carrera] column.
	 * 
	 * @param      int $v new value
	 * @return     Post The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fecha_etapa_carrera_fecha_inicio = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->fecha_etapa_carrera_id_etapa = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->fecha_etapa_carrera_id_carrera = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = PostPeer::NUM_COLUMNS - PostPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsuarioRelatedByCreatedBy !== null && $this->created_by !== $this->aUsuarioRelatedByCreatedBy->getId()) {
			$this->aUsuarioRelatedByCreatedBy = null;
		}
		if ($this->aUsuarioRelatedByUpdatedBy !== null && $this->updated_by !== $this->aUsuarioRelatedByUpdatedBy->getId()) {
			$this->aUsuarioRelatedByUpdatedBy = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsuarioRelatedByCreatedBy !== null) {
				if ($this->aUsuarioRelatedByCreatedBy->isModified() || $this->aUsuarioRelatedByCreatedBy->isNew()) {
			...
			if ($this->aUsuarioRelatedByUpdatedBy !== null) {
				if ($this->aUsuarioRelatedByUpdatedBy->isModified() || $this->aUsuarioRelatedByUpdatedBy->isNew()) {
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByCreatedBy(Usuario $v = null)
	{
		if ($v === null) {
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByCreatedBy === null && ($this->created_by !== null)) {
			$c = new Criteria(UsuarioPeer::DATABASE_NAME);
			$c->add(UsuarioPeer::ID, $this->created_by);
			$this->aUsuarioRelatedByCreatedBy = UsuarioPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByCreatedBy->addPostsRelatedByCreatedBy($this);
			 */
		}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByUpdatedBy(Usuario $v = null)
	{
		if ($v === null) {
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			$c = new Criteria(UsuarioPeer::DATABASE_NAME);
			$c->add(UsuarioPeer::ID, $this->updated_by);
			$this->aUsuarioRelatedByUpdatedBy = UsuarioPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByUpdatedBy->addPostsRelatedByUpdatedBy($this);
			 */
		}

...
abstract class BaseGrupoPeer {
	...
	const CREATED_AT = 'grupo.CREATED_AT';

	
	const CREATED_BY = 'grupo.CREATED_BY';

	
	const UPDATED_AT = 'grupo.UPDATED_AT';

	
	const UPDATED_BY = 'grupo.UPDATED_BY';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (GrupoPeer::ID, GrupoPeer::NOMBRE, GrupoPeer::CREATED_AT, GrupoPeer::CREATED_BY, GrupoPeer::UPDATED_AT, GrupoPeer::UPDATED_BY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (GrupoPeer::ID => 0, GrupoPeer::NOMBRE => 1, GrupoPeer::CREATED_AT => 2, GrupoPeer::CREATED_BY => 3, GrupoPeer::UPDATED_AT => 4, GrupoPeer::UPDATED_BY => 5, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(GrupoPeer::CREATED_AT);

		$criteria->addSelectColumn(GrupoPeer::CREATED_BY);

		$criteria->addSelectColumn(GrupoPeer::UPDATED_AT);

		$criteria->addSelectColumn(GrupoPeer::UPDATED_BY);

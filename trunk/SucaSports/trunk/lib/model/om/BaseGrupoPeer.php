  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseGrupoPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(GrupoPeer::ID) && $criteria->keyContainsValue(GrupoPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.GrupoPeer::ID.')');
		}

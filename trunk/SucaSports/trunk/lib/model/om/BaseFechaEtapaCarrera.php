...
/**
 * Base class that represents a row from the 'fecha_etapa_carrera' table.
 *
 * 
 *
...
abstract class BaseFechaEtapaCarrera extends BaseObject  implements Persistent {
  ...
  const PEER = 'FechaEtapaCarreraPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        FechaEtapaCarreraPeer
	 */
	...
	/**
	 * The value for the max_corredores field.
	 * @var        int
	 */
	...
	/**
	 * Initializes internal state of BaseFechaEtapaCarrera object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [max_corredores] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     FechaEtapaCarrera The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [max_corredores] column.
	 * 
	 * @param      int $v new value
	 * @return     FechaEtapaCarrera The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(FechaEtapaCarreraPeer::ESTADO))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fecha_inicio = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->id_etapa = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->id_carrera = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->max_corredores = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->fecha_fin = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->costo = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
			...
			return $startcol + 11; // 11 = FechaEtapaCarreraPeer::NUM_COLUMNS - FechaEtapaCarreraPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = FechaEtapaCarreraPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseFechaEtapaCarrera:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseFechaEtapaCarrera:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseFechaEtapaCarrera:save:pre') as $callable)
    {
    ...
    if ($this->isModified() && !$this->isColumnModified(FechaEtapaCarreraPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseFechaEtapaCarrera:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			FechaEtapaCarreraPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of FechaEtapaCarrera (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     FechaEtapaCarrera Clone of current object.
	 * @throws     PropelException
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseFechaEtapaCarrera:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseFechaEtapaCarrera::%s', $method));
    }

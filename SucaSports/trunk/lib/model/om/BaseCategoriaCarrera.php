...
/**
 * Base class that represents a row from the 'categoria_carrera' table.
 *
 * 
 *
...
abstract class BaseCategoriaCarrera extends BaseObject  implements Persistent {
  ...
  const PEER = 'CategoriaCarreraPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CategoriaCarreraPeer
	 */
	...
	/**
	 * Initializes internal state of BaseCategoriaCarrera object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CategoriaCarrera The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CategoriaCarreraPeer::ID_CATEGORIA,CategoriaCarreraPeer::ID_CARRERA))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = CategoriaCarreraPeer::NUM_COLUMNS - CategoriaCarreraPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CategoriaCarreraPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCategoriaCarrera:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCategoriaCarrera:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCategoriaCarrera:save:pre') as $callable)
    {
    ...
    if ($this->isModified() && !$this->isColumnModified(CategoriaCarreraPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCategoriaCarrera:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CategoriaCarreraPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CategoriaCarrera (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CategoriaCarrera Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getCategoria(PropelPDO $con = null)
	{
		if ($this->aCategoria === null && ($this->id_categoria !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCategoria->addCategoriaCarreras($this);
			 */
		}
	...
	public function getCarrera(PropelPDO $con = null)
	{
		if ($this->aCarrera === null && ($this->id_carrera !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCarrera->addCategoriaCarreras($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCategoriaCarrera:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCategoriaCarrera::%s', $method));
    }

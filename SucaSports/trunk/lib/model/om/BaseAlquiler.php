...
abstract class BaseAlquiler extends BaseObject  implements Persistent {
  ...
  const PEER = 'AlquilerPeer';
	...
	/**
	 * The value for the id_inventario field.
	 * @var        int
	 */
	...
	/**
	 * The value for the id_cuenta_corriente field.
	 * @var        int
	 */
	...
	/**
	 * Get the [id_inventario] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [id_cuenta_corriente] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [id_inventario] column.
	 * 
	...
	/**
	 * Set the value of [id_cuenta_corriente] column.
	 * 
	 * @param      int $v new value
	 * @return     Alquiler The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_inventario = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->id_cuenta_corriente = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			...
			return $startcol + 10; // 10 = AlquilerPeer::NUM_COLUMNS - AlquilerPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aInventario !== null && $this->id_inventario !== $this->aInventario->getId()) {
			$this->aInventario = null;
		}
	} // ensureConsistency
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdInventario($this->id_inventario);
		...
		$copyObj->setIdCuentaCorriente($this->id_cuenta_corriente);
	 ...
	 * @throws     PropelException
	 */
	public function getInventario(PropelPDO $con = null)
	{
		if ($this->aInventario === null && ($this->id_inventario !== null)) {
			$c = new Criteria(InventarioPeer::DATABASE_NAME);
			$c->add(InventarioPeer::ID, $this->id_inventario);
			$this->aInventario = InventarioPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aInventario->addAlquilers($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseAlquiler:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseAlquiler::%s', $method));
    }

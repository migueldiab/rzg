...
/**
 * Base class that represents a row from the 'corredor_equipamiento' table.
 *
 * 
 *
...
abstract class BaseCorredorEquipamiento extends BaseObject  implements Persistent {
  ...
  const PEER = 'CorredorEquipamientoPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CorredorEquipamientoPeer
	 */
	...
	/**
	 * The value for the id_equipamiento field.
	 * @var        int
	 */
	...
	/**
	 * Initializes internal state of BaseCorredorEquipamiento object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [id_equipamiento] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     CorredorEquipamiento The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [id_equipamiento] column.
	 * 
	 * @param      int $v new value
	 * @return     CorredorEquipamiento The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_equipamiento = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			...
			return $startcol + 4; // 4 = CorredorEquipamientoPeer::NUM_COLUMNS - CorredorEquipamientoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aEquipamiento !== null && $this->id_equipamiento !== $this->aEquipamiento->getId()) {
			$this->aEquipamiento = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CorredorEquipamientoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCorredorEquipamiento:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCorredorEquipamiento:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCorredorEquipamiento:save:pre') as $callable)
    {
    ...
    if ($this->isModified() && !$this->isColumnModified(CorredorEquipamientoPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCorredorEquipamiento:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CorredorEquipamientoPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CorredorEquipamiento (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CorredorEquipamiento Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CorredorEquipamientoPeer
	 */
	...
	public function setCorredor(Corredor $v = null)
	{
		...
		if ($v !== null) {
			$v->addCorredorEquipamiento($this);
		}
	...
	public function getCorredor(PropelPDO $con = null)
	{
		if ($this->aCorredor === null && ($this->id_corredor !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCorredor->addCorredorEquipamientos($this);
			 */
		}
	...
	public function getEquipamiento(PropelPDO $con = null)
	{
		if ($this->aEquipamiento === null && ($this->id_equipamiento !== null)) {
			...
			$c->add(EquipamientoPeer::ID, $this->id_equipamiento);
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEquipamiento->addCorredorEquipamientos($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCorredorEquipamiento:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCorredorEquipamiento::%s', $method));
    }

...
/**
 * Base class that represents a row from the 'equipamiento_carrera' table.
 *
 * 
 *
...
abstract class BaseEquipamientoCarrera extends BaseObject  implements Persistent {
  ...
  const PEER = 'EquipamientoCarreraPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        EquipamientoCarreraPeer
	 */
	...
	/**
	 * Initializes internal state of BaseEquipamientoCarrera object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     EquipamientoCarrera The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_tipo_equipamiento = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 8; // 8 = EquipamientoCarreraPeer::NUM_COLUMNS - EquipamientoCarreraPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EquipamientoCarreraPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseEquipamientoCarrera:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseEquipamientoCarrera:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseEquipamientoCarrera:save:pre') as $callable)
    {
    ...
    if ($this->isModified() && !$this->isColumnModified(EquipamientoCarreraPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseEquipamientoCarrera:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			EquipamientoCarreraPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EquipamientoCarrera (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EquipamientoCarrera Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EquipamientoCarreraPeer
	 */
	...
	public function getTipoEquipamiento(PropelPDO $con = null)
	{
		if ($this->aTipoEquipamiento === null && ($this->id_tipo_equipamiento !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTipoEquipamiento->addEquipamientoCarreras($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseEquipamientoCarrera:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseEquipamientoCarrera::%s', $method));
    }

...
abstract class BasePostPeer {
	...
	/** the column name for the FECHA_ETAPA_CARRERA_FECHA_INICIO field */
	const FECHA_ETAPA_CARRERA_FECHA_INICIO = 'post.FECHA_ETAPA_CARRERA_FECHA_INICIO';

	/** the column name for the FECHA_ETAPA_CARRERA_ID_ETAPA field */
	const FECHA_ETAPA_CARRERA_ID_ETAPA = 'post.FECHA_ETAPA_CARRERA_ID_ETAPA';

	/** the column name for the FECHA_ETAPA_CARRERA_ID_CARRERA field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'texto', 'createdBy', 'createdAt', 'updatedBy', 'updatedAt', 'fechaEtapaCarreraFechaInicio', 'fechaEtapaCarreraIdEtapa', 'fechaEtapaCarreraIdCarrera', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TEXTO, self::CREATED_BY, self::CREATED_AT, self::UPDATED_BY, self::UPDATED_AT, self::FECHA_ETAPA_CARRERA_FECHA_INICIO, self::FECHA_ETAPA_CARRERA_ID_ETAPA, self::FECHA_ETAPA_CARRERA_ID_CARRERA, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'texto' => 1, 'createdBy' => 2, 'createdAt' => 3, 'updatedBy' => 4, 'updatedAt' => 5, 'fechaEtapaCarreraFechaInicio' => 6, 'fechaEtapaCarreraIdEtapa' => 7, 'fechaEtapaCarreraIdCarrera' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TEXTO => 1, self::CREATED_BY => 2, self::CREATED_AT => 3, self::UPDATED_BY => 4, self::UPDATED_AT => 5, self::FECHA_ETAPA_CARRERA_FECHA_INICIO => 6, self::FECHA_ETAPA_CARRERA_ID_ETAPA => 7, self::FECHA_ETAPA_CARRERA_ID_CARRERA => 8, ),
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $criteria, $con);
    }
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByCreatedBy table
	 *
	 * @param      Criteria $c
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(PostPeer::CREATED_BY,), array(UsuarioPeer::ID,), $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByUpdatedBy table
	 *
	 * @param      Criteria $c
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(array(PostPeer::UPDATED_BY,), array(UsuarioPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Post objects pre-filled with their Usuario objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByCreatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{

    foreach (sfMixer::getCallables('BasePostPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $c, $con);
    }
		...
		$c->addJoin(array(PostPeer::CREATED_BY,), array(UsuarioPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Post) to $obj2 (Usuario)
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByUpdatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(PostPeer::UPDATED_BY,), array(UsuarioPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Post) to the collection in $obj2 (Usuario)
				$obj2->addPostRelatedByCreatedBy($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Post) to the collection in $obj3 (Usuario)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Post objects pre-filled with all related objects except UsuarioRelatedByCreatedBy.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByCreatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{

    foreach (sfMixer::getCallables('BasePostPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $c, $con);
    }
	...
	/**
	 * Selects a collection of Post objects pre-filled with all related objects except UsuarioRelatedByUpdatedBy.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByUpdatedBy(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BasePostPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BasePostPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BasePostPeer', $values, $con, $ret);
    }

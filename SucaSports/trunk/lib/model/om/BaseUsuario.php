...
abstract class BaseUsuario extends BaseObject  implements Persistent {
  ...
  const PEER = 'UsuarioPeer';
	...
	/**
	 * The value for the pregunta_secreta field.
	 * @var        string
	 */
	protected $pregunta_secreta;

	/**
	 * The value for the respuesta_secreta field.
	 * @var        string
	 */
	...
	/**
	 * The value for the verificador field.
	 * @var        string
	 */
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collPostsRelatedByCreatedBy.
	 */
	private $lastPostRelatedByCreatedByCriteria = null;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collPostsRelatedByUpdatedBy.
	 */
	private $lastPostRelatedByUpdatedByCriteria = null;
	...
	/**
	 * Get the [pregunta_secreta] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [respuesta_secreta] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [verificador] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [pregunta_secreta] column.
	 * 
	 * @param      string $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [respuesta_secreta] column.
	 * 
	 * @param      string $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [verificador] column.
	 * 
	 * @param      string $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_grupo = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->id_corredor = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->pregunta_secreta = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->respuesta_secreta = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->estado = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->verificador = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aGrupo !== null && $this->id_grupo !== $this->aGrupo->getId()) {
			$this->aGrupo = null;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastPostRelatedByCreatedByCriteria = null;

			$this->collPostsRelatedByUpdatedBy = null;
			$this->lastPostRelatedByUpdatedByCriteria = null;
	...
	public function getGrupo(PropelPDO $con = null)
	{
		if ($this->aGrupo === null && ($this->id_grupo !== null)) {
			...
			$c->add(GrupoPeer::ID, $this->id_grupo);
	...
	public function getCorredor(PropelPDO $con = null)
	{
		if ($this->aCorredor === null && ($this->id_corredor !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCorredor->addUsuarios($this);
			 */
		}
	...
	/**
	 * Clears out the collPostsRelatedByCreatedBy collection (array).
	 *
	...
	/**
	 * Initializes the collPostsRelatedByCreatedBy collection (array).
	 *
	 ...
	 * related PostsRelatedByCreatedBy from storage. If this Usuario is new, it will return
		...
		if ($this->collPostsRelatedByCreatedBy === null) {
			if ($this->isNew()) {
			   $this->collPostsRelatedByCreatedBy = array();
				...
				$criteria->add(PostPeer::CREATED_BY, $this->id);
		...
		if ($this->collPostsRelatedByCreatedBy === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastPostRelatedByCreatedByCriteria) || !$this->lastPostRelatedByCreatedByCriteria->equals($criteria)) {
					...
					$count = count($this->collPostsRelatedByCreatedBy);
				}
			} else {
				$count = count($this->collPostsRelatedByCreatedBy);
			}
	...
	public function addPostRelatedByCreatedBy(Post $l)
	{
		...
		if (!in_array($l, $this->collPostsRelatedByCreatedBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPostsRelatedByCreatedBy, $l);
			$l->setUsuarioRelatedByCreatedBy($this);
		}
	}

	/**
	 * Clears out the collPostsRelatedByUpdatedBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collPostsRelatedByUpdatedBy collection (array).
	 *
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Usuario has previously been saved, it will retrieve
	 * related PostsRelatedByUpdatedBy from storage. If this Usuario is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPostsRelatedByUpdatedBy === null) {
			if ($this->isNew()) {
			   $this->collPostsRelatedByUpdatedBy = array();
				...
				$criteria->add(PostPeer::UPDATED_BY, $this->id);
		...
		if ($this->collPostsRelatedByUpdatedBy === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastPostRelatedByUpdatedByCriteria) || !$this->lastPostRelatedByUpdatedByCriteria->equals($criteria)) {
					...
					$count = count($this->collPostsRelatedByUpdatedBy);
				}
			} else {
				$count = count($this->collPostsRelatedByUpdatedBy);
			}
	...
	public function addPostRelatedByUpdatedBy(Post $l)
	{
		...
		if (!in_array($l, $this->collPostsRelatedByUpdatedBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPostsRelatedByUpdatedBy, $l);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collPostsRelatedByCreatedBy) {
				foreach ((array) $this->collPostsRelatedByCreatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collPostsRelatedByUpdatedBy) {
				foreach ((array) $this->collPostsRelatedByUpdatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)

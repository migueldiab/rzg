...
abstract class BaseConfiguracion extends BaseObject  implements Persistent {
  ...
  const PEER = 'ConfiguracionPeer';
	...
	/**
	 * The value for the parametro field.
	 * @var        string
	 */
	protected $parametro;
	...
	/**
	 * Get the [parametro] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [parametro] column.
	 * 
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->parametro = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 6; // 6 = ConfiguracionPeer::NUM_COLUMNS - ConfiguracionPeer::NUM_LAZY_LOAD_COLUMNS).

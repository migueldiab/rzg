...
INSERT INTO fecha_etapa_carrera(max_corredores,fecha_inicio,fecha_fin,id_etapa_carrera,id_carrera) VALUES(10,current_date,current_date,(select max(id) from etapa_carrera),(select max(id) from carrera));
